  ...
  const uploadAudioToServer = async (blob) => {
    ...
    try {
      const response = await fetch("http://localhost:1337/api/upload/", {
        ...
        headers: {
          Authorization:
            "bearer ", // Ajoutez l'en-tête d'autorisation si nécessaire
        },
      });
